    ...
    <form method="post" action="member.php">
        <div class="formblock">
            ...
            <p>
                ...
                <input type="text" name="username" id="passwd">
            </p>
            <p>
...
function display_registration_form(){
    ...
    <form method="post" action="register_new.php">
        <div class="formblock">
            ...
            <p>
                <label for="passwd2">Confirm Passwd:</label><br />
...
function display_add_bm_form(){
    ...
    <form name="bm_table" action="add_bms.php" method="post">
        <div class="formblock">
            <h2>New Bookmark</h2>
            <p>
                <input type="text" name="new_url" id="new_url" size="40" maxlength="255"
                    value="http://" required />
            </p>
...
function display_password_form(){
    ...
    <form action="change_passwd.php" method="post">
        <div class="formlock">
            ...
            <p>
                <label for="passwd2">Repeat New Password:</label><br />
